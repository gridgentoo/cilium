...
func GetWorkloadMetaFromPod(pod *slim_corev1.Pod) (slim_metav1.ObjectMeta, slim_metav1.TypeMeta) {
	if pod == nil {
		return slim_metav1.ObjectMeta{}, slim_metav1.TypeMeta{}
	}
	...
	typeMetadata := slim_metav1.TypeMeta{
		Kind:       "Pod",
		APIVersion: "v1",
	}
	...
	if workloadObjectMeta.Name == "" {
		// if we haven't been able to extract a deployment name, then just give it the pod name
		workloadObjectMeta.Name = pod.Name
	}

	return workloadObjectMeta, typeMetadata
}
